...
import com.example.imdb.Activities.Activities.Activities.WatchListActivity;
...
public class WatchMovieResultAdapter extends RecyclerView.Adapter<WatchMovieResultAdapter.ViewHolder>{
    private List<Result> movieResultList;

    private Result result;
    public WatchMovieResultAdapter(List<Result> movieResultList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.watchlist_movie_list_item, viewGroup, false);
